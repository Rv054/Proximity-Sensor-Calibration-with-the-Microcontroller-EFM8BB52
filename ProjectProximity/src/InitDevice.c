...
PBCFG_0_enter_DefaultMode_from_RESET (void)
{
  ...
  /***********************************************************************
   - Weak Pullups enabled (WEAKPUD)
   - Crossbar enabled (XBARE)
   - PWM single ended output for all enabled channels (PWMDE)
   - UART1 I/O unavailable at Port pin (URT1E)
   - UART1 RTS1 unavailable at Port pin (URT1RTSE)
   - UART1 CTS1 unavailable at Port pin (URT1CTSE)
   - PWM I/O unavailable at Port pin (PWME)
   ***********************************************************************/
  SFRPAGE = 0x00;
  ...
  /***********************************************************************
   - UART0 I/O enabled at Port pin (URTOE)
   - SPI I/O unavailable at Port pins (SPIOE)
   - SMBus 0 I/O routed to Port pins (SMB0E)
   - CP0 unavailable at Port pin (CP0E)
   - Asynchronous CP0 unavailable at Port pin (CP0AE)
   - CP1 unavailable at Port pin (CP1E)
   - Asynchronous CP1 unavailable at Port pin (CP1AE)
   - SYSCLK unavailable at Port pin (SYSCKE)
   ***********************************************************************/
...
INTERRUPT_0_enter_DefaultMode_from_RESET (void)
{
  ...
  // $[IE - Interrupt Enable]
  /***********************************************************************
   - Enable each interrupt according to its individual mask setting (EA)
   - Disable external interrupt 0 (EX0)
   - Disable external interrupt 1 (EX1)
   - Disable all SPI0 interrupts (ESPI0)
   - Disable all Timer 0 interrupt (ET0)
   - Disable all Timer 1 interrupt (ET1)
   - Disable interrupt requests generated by the TF2L or TF2H flags (ET2)
   - Enable UART0 interrupt (ES0)
   ***********************************************************************/
...
SMBUS_0_enter_DefaultMode_from_RESET (void)
{
   ...
   ***********************************************************************/
  SMB0CF |= SMB0CF_ENSMB__ENABLED | SMB0CF_INH__SLAVE_DISABLED | SMB0CF_SMBFTE__FREE_TO_ENABLED | SMB0CF_SMBCS__TIMER0;
